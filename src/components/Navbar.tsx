    ...
    <header className="bg-background relative z-50">
      ...
      <div className="border-b border-border">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 h-[60px] md:h-[72px] flex items-center justify-between relative">
          ...
          <Link
            to="/"
            className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 pt-2 md:pt-3 font-brand text-[32px] md:text-[40px] tracking-[0.04em] font-normal leading-[1] text-ink"
          >
            Gea
          </Link>
