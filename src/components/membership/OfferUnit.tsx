...
const FullOffer = ({ ctaHref }: { ctaHref: string }) => (
  <div className="space-y-8">
    ...
    >
      ...
      <p className="mx-auto mt-2 max-w-[560px] font-sans text-[13px] leading-relaxed text-muted-foreground md:text-[14px]">
        Wear every earring, pain-free. Free <span className="font-semibold text-foreground">earring patches + lifters</span> in each box prevent allergies, soreness, and stretched lobes — and make heavier pieces sit beautifully. <span style={{ color: "var(--poppy-deep)" }}>A $30 value, included.</span>
      </p>
    </div>
