        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <StaggerItem>
            <div className="border border-border bg-card p-8 h-full relative overflow-hidden">
              ...
              <OrganicBlobTag variant="coastal" className="mb-4">Brand Assets</OrganicBlobTag>
          ...
          <StaggerItem>
            <div className="border border-border bg-card p-8 h-full relative overflow-hidden">
              <GrainOverlay opacity={0.03} />
              <OrganicBlobTag variant="classic" className="mb-4">Imagery</OrganicBlobTag>
          ...
          <StaggerItem>
            <div className="border border-border bg-card p-8 h-full relative overflow-hidden">
              <GrainOverlay opacity={0.03} />
              <OrganicBlobTag variant="statement" className="mb-4">Inquiries</OrganicBlobTag>
