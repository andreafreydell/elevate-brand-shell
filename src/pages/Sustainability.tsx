    ...
    <PageLayout>
      ...
      <section className="max-w-[1440px] mx-auto px-5 sm:px-6 md:px-12 lg:px-16 pb-16">
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <StaggerItem><ValueBlock title="Lab-Created Stones" description="Every GEA piece features lab-created moissanite — optically superior to diamond, conflict-free, and requiring zero mining. Brilliance without extraction." className="bg-card" lucideIcon={Gem} label="Material 01" /></StaggerItem>
          <StaggerItem><ValueBlock title="Access Over Landfill" description="A single piece in the GEA vault serves dozens of members across hundreds of wears. Access extends the lifecycle of every gram of metal and every set stone." className="bg-card" lucideIcon={Recycle} label="Material 02" /></StaggerItem>
          <StaggerItem><ValueBlock title="In-House Restoration" description="Our atelier restores each piece between members: hand cleaning, UV sanitization, 4-point inspection. Nothing is discarded. Everything is renewed." className="bg-card" lucideIcon={Wrench} label="Material 03" /></StaggerItem>
        </StaggerContainer>
      </section>
