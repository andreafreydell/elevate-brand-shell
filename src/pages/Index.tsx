    ...
    <PageLayout>
      ...
      <section className="bg-[hsl(28,22%,34%)]">
        <div className="max-w-[1440px] mx-auto px-5 sm:px-6 md:px-12 lg:px-16 py-20 md:py-28 text-center">
          <p className="text-[10px] tracking-[0.4em] uppercase text-[hsl(36,25%,78%)] mb-6 font-sans">Coming Soon</p>
          <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-medium leading-[1.1] tracking-[-0.01em] text-[hsl(36,33%,93%)] mb-4">
            We're Building{"\n"}Something Beautiful.
          </h2>
          <p className="text-[13px] text-[hsl(36,20%,75%)] font-sans max-w-[440px] mx-auto mb-4 leading-relaxed">
            GEA is launching soon. Be the first to access the vault — founding members lock in
            the lowest rate forever, get priority selection, and complimentary styling.
          </p>
