...
const values = [
  {
    title: "Artistry Without Extraction",
    description:
      "Every piece uses lab-created moissanite and recycled metals. No mining. No compromise on brilliance.",
    icon: Gem,
    label: "Principle 01",
  },
  {
          ...
          <AnimateIn variant="fadeUp" delay={0.15} duration={0.6}>
            <div className="bg-card border border-border p-10 md:p-14 flex flex-col justify-center h-full relative overflow-hidden">
              ...
              <StampBadge
                ...
                subtext="2026"
                rotation={-10}
                className="absolute bottom-4 left-4 hidden md:inline-flex"
              />
              ...
              <div className="max-w-content">
                <p className="text-[13px] text-foreground font-sans leading-[1.8] mb-6 relative z-[1]">
                  I grew up watching my mother transform everything she touched - and build a company that
                  empowered millions of women to create the lives and homes they imagined. I wanted to follow
          ...
          <HandDrawnFrame strokeColor="hsl(var(--foreground))">
            <div className="mx-auto max-w-[760px] text-center">
              ...
              <p className="mx-auto max-w-[560px] font-sans text-[13px] leading-relaxed text-muted-foreground">
                ...
                high-design jewelry: more variety, less clutter, free shipping, and a collection you build through
        ...
        <div className="max-w-[1440px] mx-auto px-5 sm:px-6 md:px-12 lg:px-16 py-16 md:py-20 text-center relative z-[1]">
          <AnimateIn variant="fadeUp" duration={0.5}>
            <HandDrawnFrame strokeColor="hsl(var(--foreground))">
              ...
              <p className="mx-auto mb-8 max-w-[460px] font-sans text-[13px] leading-relaxed text-muted-foreground">
                Start with the offer, then browse the vault. The membership page breaks down cycle length,
